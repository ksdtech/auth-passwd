 ...
 *  PFZ: combined source into one file, and generated new apxs Makefile for OS X Server 10.5
 *  PFZ: changed 'r' query param in redirect to 'url'
 *  PFZ: original source code at http://home.digithi.de/digithi/dev/mod_auth_cookie_mysql/
 */
